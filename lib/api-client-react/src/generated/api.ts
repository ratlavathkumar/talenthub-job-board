 ...
 */
export const registerUser = async (userRegisterInput: UserRegisterInput, options?: RequestInit): Promise<AuthUserResponse> => {
...
export const getGetUserMeUrl = () => {
  ...
  return `/api/auth/user/me`
}

/**
 * @summary Get current candidate session
 */
export const getUserMe = async ( options?: RequestInit): Promise<AuthUserResponse> => {

  return customFetch<AuthUserResponse>(getGetUserMeUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const updateUserProfile = async (userProfileUpdate: UserProfileUpdate, options?: RequestInit): Promise<AuthUserResponse> => {

  return customFetch<AuthUserResponse>(getUpdateUserProfileUrl(),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRegisterCompanyUrl = () => {
  ...
  return `/api/auth/company/register`
}

/**
 * @summary Register a new company account
 */
export const registerCompany = async (companyRegisterInput: CompanyRegisterInput, options?: RequestInit): Promise<AuthCompanyResponse> => {

  return customFetch<AuthCompanyResponse>(getRegisterCompanyUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRegisterCompanyMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof registerCompany>>, TError,{data: BodyType<CompanyRegisterInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof registerCompany>>, TError,{data: BodyType<CompanyRegisterInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof registerCompany>>, {data: BodyType<CompanyRegisterInput>}> = (props) => {
          const {data} = props ?? {};
...
export const getLoginCompanyUrl = () => {
  ...
  return `/api/auth/company/login`
}

/**
 * @summary Login as a company
 */
export const loginCompany = async (loginInput: LoginInput, options?: RequestInit): Promise<AuthCompanyResponse> => {

  return customFetch<AuthCompanyResponse>(getLoginCompanyUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getLoginCompanyMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginCompany>>, TError,{data: BodyType<LoginInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof loginCompany>>, TError,{data: BodyType<LoginInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof loginCompany>>, {data: BodyType<LoginInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LoginCompanyMutationResult = NonNullable<Awaited<ReturnType<typeof loginCompany>>>
    export type LoginCompanyMutationBody = BodyType<LoginInput>
    export type LoginCompanyMutationError = ErrorType<void>

    /**
 * @summary Login as a company
 */
export const useLoginCompany = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof loginCompany>>, TError,{data: BodyType<LoginInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getLogoutCompanyUrl = () => {




  return `/api/auth/company/logout`
}

/**
 * @summary Logout company
 */
export const logoutCompany = async ( options?: RequestInit): Promise<OkResponse> => {

  return customFetch<OkResponse>(getLogoutCompanyUrl(),
  {
    ...options,
    method: 'POST'
...
export const getLogoutCompanyMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof logoutCompany>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof logoutCompany>>, TError,void, TContext> => {

const mutationKey = ['logoutCompany'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof logoutCompany>>, void> = () => {


          return  logoutCompany(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type LogoutCompanyMutationResult = NonNullable<Awaited<ReturnType<typeof logoutCompany>>>

    export type LogoutCompanyMutationError = ErrorType<unknown>

    /**
 * @summary Logout company
 */
export const useLogoutCompany = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof logoutCompany>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getLogoutCompanyMutationOptions(options));
    }

export const getGetCompanyMeUrl = () => {




  return `/api/auth/company/me`
}

/**
 * @summary Get current company session
 */
export const getCompanyMe = async ( options?: RequestInit): Promise<AuthCompanyResponse> => {

  return customFetch<AuthCompanyResponse>(getGetCompanyMeUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetCompanyMeQueryKey = () => {
    return [
    `/api/auth/company/me`
    ] as const;
    }
...
export const getGetCompanyMeQueryOptions = <TData = Awaited<ReturnType<typeof getCompanyMe>>, TError = ErrorType<void>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCompanyMe>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetCompanyMeQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCompanyMe>>> = ({ signal }) => getCompanyMe({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCompanyMe>>, TError, TData> & { queryKey: QueryKey }
}

export type GetCompanyMeQueryResult = NonNullable<Awaited<ReturnType<typeof getCompanyMe>>>
export type GetCompanyMeQueryError = ErrorType<void>
...
export function useGetCompanyMe<TData = Awaited<ReturnType<typeof getCompanyMe>>, TError = ErrorType<void>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCompanyMe>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetCompanyMeQueryOptions(options)
 ...
 */
export const updateCompanyProfile = async (companyProfileUpdate: CompanyProfileUpdate, options?: RequestInit): Promise<AuthCompanyResponse> => {

  return customFetch<AuthCompanyResponse>(getUpdateCompanyProfileUrl(),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
 ...
 */
export const adminListCompanies = async ( options?: RequestInit): Promise<CompanyPublic[]> => {

  return customFetch<CompanyPublic[]>(getAdminListCompaniesUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const adminUpdateCompany = async (id: number,
    adminCompanyUpdate: AdminCompanyUpdate, options?: RequestInit): Promise<CompanyPublic> => {

  return customFetch<CompanyPublic>(getAdminUpdateCompanyUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getAdminUpdateCompanyMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminUpdateCompany>>, TError,{id: number;data: BodyType<AdminCompanyUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof adminUpdateCompany>>, TError,{id: number;data: BodyType<AdminCompanyUpdate>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminUpdateCompany>>, {id: number;data: BodyType<AdminCompanyUpdate>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminUpdateCompanyMutationBody = BodyType<AdminCompanyUpdate>
...
export const useAdminUpdateCompany = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminUpdateCompany>>, TError,{id: number;data: BodyType<AdminCompanyUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: number;data: BodyType<AdminCompanyUpdate>},
        TContext
      > => {
      return useMutation(getAdminUpdateCompanyMutationOptions(options));
    }

export const getAdminDeleteCompanyUrl = (id: number,) => {
 ...
 */
export const adminDeleteCompany = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getAdminDeleteCompanyUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getAdminDeleteCompanyMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminDeleteCompany>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof adminDeleteCompany>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof adminDeleteCompany>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  adminDeleteCompany(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AdminDeleteCompanyMutationResult = NonNullable<Awaited<ReturnType<typeof adminDeleteCompany>>>

    export type AdminDeleteCompanyMutationError = ErrorType<unknown>

    /**
 * @summary Admin - delete a company
 */
export const useAdminDeleteCompany = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof adminDeleteCompany>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const adminListUsers = async ( options?: RequestInit): Promise<UserPublic[]> => {

  return customFetch<UserPublic[]>(getAdminListUsersUrl(),
  {
    ...options,
    method: 'GET'
